...
public class filaVirtualController {
    ...
    public String atenderPrimero() {
        ...
        try {
            String urlOperaciones = "http://localhost:8081/api/operaciones/validar/" + patente;
            ...
            return "Error: No se pudo contactar al módulo de ms-operaciones. Asegúrate de que el puerto 8081 esté encendido.";
        }
    }
}