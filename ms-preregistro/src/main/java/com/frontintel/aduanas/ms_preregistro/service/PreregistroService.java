...
public class PreregistroService {
    ...
    private final KafkaTemplate<String, EventoCruceDto> kafkaTemplate;

    private static final String TOPIC_TRAMITES = "tramites-aduanas-topic";
    ...
    public PreregistroResponseDto crearPreregistro(PreregistroRequestDto dto) {
        ...
        // Publicar evento asíncrono en Kafka para ms-notificaciones
        ...
        kafkaTemplate.send(TOPIC_TRAMITES, evento);
        log.info("Evento publicado en Kafka para asignación de turno en fila virtual.");
